...
func init() {
	...
	utilruntime.Must(cnpgclaimv1alpha1.AddToScheme(scheme))
}
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "cnpg-dbclaim-operator.cnpg.wyvernzora.io",
	})
	if err != nil {
	...
	if err := (&controller.RoleClaimReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "RoleClaim")
		os.Exit(1)
	}
